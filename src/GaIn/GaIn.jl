using  FLoops
const GaIn_lib = "/home/lvidal/Documents/CERMICS/these/wannier_and_GTOs/molint/GaIn-1.0/src/lib.so"
struct Ccplx
    r::Cdouble
    i::Cdouble
end
...
function c_coulomb_c(ζ1::Cdouble, R1::Vector{Cdouble}, nx1::Int, ny1::Int, nz1::Int,
                     ζ2::Cdouble, R2::Vector{Cdouble}, nx2::Int, ny2::Int, nz2::Int)
