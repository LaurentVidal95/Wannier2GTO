...
!!
recursive function D_X_R_opt_1_1(a12,a3,r3,c,lmax,value)
  ...
  value=0.0d0
  u71=a3**(-1)
  u65=-5.0d-1*u71*A2_(p,pd,erfpd,exppd2)*p**2
  value=value+(c(1)*(u65*x))
  if ( lmax .eq. 0 ) return
  u65=A3_(p,pd,erfpd,exppd2)
  u76=p**3
  u87=9.40315972579593812d-2*u71*(5.31736155271654808d0*u65+4.0d0*exppd&
 &2)*u76
  u66=-1.5d0*u71*u65*u76
  u68=x**2
  ...
  u69=u71*u66*u77
  u74=4.5d0*u69
  u67=-2.82094791773878144d-1*u71
  u90=exppd2*pd
  u83=-8.0d0*u90
  u63=+u67*(2.65868077635827404d1*u66+u83)*u77
  u81=u63*u68
  ...
  u74=p**5
  u92=8.0d0*exppd2
  u7=u71*(u92+2.65868077635827404d1*u63)*u74
  u8=-1.69256875064326886d-1*u7
  u75=u71*u63*u74
  u85=4.5d1*u75
  u93=-1.6d1*exppd2
  u84=+u93*pd2
  u79=+u67*(1.86107654345079183d2*u63+u84)*u74
  u64=u79*u68
  ...
  u79=-1.125d2*u73
  u85=-1.6d1*u90
  u7=u71*(1.86107654345079183d2*u64+u85)*u75
  u8=2.82094791773878144d0*u7
  u91=2.0d0*pd2
  u82=+u67*(1.67496888910571265d3*u64+u85*(9.0d0+u91))*u75
  u61=u82*u68
  value=value+(c(21)*(x*(u68*(u8+u61)+u79)))
  u79=-2.25d1*u73
  u8=1.69256875064326886d0*u7
  u98=(u68*(u8+u61)+u79)
  value=value+(c(22)*(u98*y))
  value=value+(c(23)*(u98*z))
  u86=8.46284375321634431d-1*u7
  u97=2.82094791773878144d-1*u7
  u7=(u86+u61)
  u60=u97*u68
  u95=u60+u79
  ...
  u73=p**7
  u7=u71*(1.86107654345079183d2*u61-u93)*u73
  u77=6.04488839515453165d-1*u7
  u9=u71*u61*u73
  u97=-2.3625d3*u9
  u86=-3.2d1*exppd2*pd2
  u8=u71*(1.67496888910571265d3*u61+u86)*u73
  u95=4.23142187660817215d0*u8
  u79=(1.1d1+u91)
  u60=u71*(1.84246577801628391d4*u61+u86*u79)*u73
  u96=-2.82094791773878144d-1*u60
  u82=u96*u68
  value=value+(c(36)*(u68*(u97+u68*(u82+u95))+u77))
  u77=-7.875d2*u9
  u97=2.82094791773878144d0*u8
  u95=x*(u68*(u97+u82)+u77)
  value=value+(c(37)*(u95*y))
  value=value+(c(38)*(u95*z))
  u86=1.20897767903090633d-1*u7
  u7=-1.575d2*u9
  u98=-3.15d2*u9
  u85=1.69256875064326886d0*u8
  u94=2.82094791773878144d-1*u8
  u99=(u7+u68*(u82+u85))
  u80=u94*u68
  u67=u68*(u98+u80)+u86
  ...
  u80=-8.05985119353937553d-2*u71*(5.58322963035237549d2*u61-u92)*u73
  u64=-2.82094791773878144d-1*u8
  u78=-1.12837916709551257d0*u71*(5.02490666731713794d3*u61+u84*(6.0d0+&
 &pd2))*u73
  u67=2.82094791773878144d-1*u60
  u60=u67*u68
 ...
 &4*u68)+u80))
  ...
  u75=5.5125d3*u93
  u82=-3.2d1*u90
  u67=u71*(1.67496888910571265d3*u62+u82)*u72
  u64=-2.96199531362572051d1*u67
  u60=1.84246577801628391d4*u62
  u77=u71*(u60+u82*u79)*u72
  u98=5.92399062725144101d0*u77
  u78=pd2**2
  u80=(u91+1.1d1)
  u7=u71*(2.39520551142116908d5*u62+u82*(1.3d1*u80+4.0d0*u78))*u72
  u79=-2.82094791773878144d-1*u7
  u85=u79*u68
  value=value+(c(57)*(x*(u68*(u64+u68*(u85+u98))+u75)))
  u75=7.875d2*u93
  u64=-1.26942656298245165d1*u67
  u98=4.23142187660817215d0*u77
  u94=(u68*(u64+u68*(u85+u98))+u75)
  value=value+(c(58)*(u94*y))
  value=value+(c(59)*(u94*z))
  u74=-4.23142187660817215d0*u67
  u86=-2.82094791773878144d0*u67
  u94=2.82094791773878144d0*u77
  ...
  u63=4.725d2*u93
  u92=-8.46284375321634431d-1*u67
  u61=-5.07770625192980658d0*u67
  u89=1.69256875064326886d0*u77
  u8=8.46284375321634431d-1*u77
  u99=(u92+u68*(u85+u89))
  u96=u99*u69
  u84=u8*u68
  u88=u68*(u61+u84)+u63
  ...
  u73=-2.53885312596490329d0*u67
  u67=(u8+u85)
  u95=u84+u73
  value=value+(c(68)*(u87*(u67*u69+u95)*z))
  u84=-6.77027500257307545d0*u71*(1.86107654345079183d2*u62-4.0d0*u90)*&
 &u72
  u76=-8.46284375321634431d-1*u77
  u90=2.82094791773878144d-1*u71*(2.17745955583742644d4*u62+u82*(1.3d1+&
 &u91))*u72
  u62=-4.5135166683820503d0*u71*(u60+u83*(4.0d0*u80+u78))*u72
  u60=2.82094791773878144d-1*u7
  u7=-2.82094791773878144d-1*u77
  u71=u60*u68
  u77=u68*(u71+u62)
...
!> Compute YY X Y coulomb integral for the right hand shell 
!!
recursive function D_X_R_opt_1_2(a12,a3,r3,c,lmax,value)
  ...
  u88=9.40315972579593812d-2*u71*(5.31736155271654808d0*u65+4.0d0*exppd&
 &2)*u76
  u68=y**2
  ...
  u89=exppd2*pd
  u83=-8.0d0*u89
  u91=+u67*(2.65868077635827404d1*u66+u83)*u77
  u69=x**2
  ...
  u91=-1.6d1*exppd2
  u84=+u91*pd2
  u94=+u67*(1.86107654345079183d2*u63+u84)*u74
  u62=u94*u69
  value=value+(c(11)*(x*(u62+u98)*y))
  u92=8.0d0*exppd2
  u75=u71*(u92+2.65868077635827404d1*u63)*u74
  u78=-5.64189583547756287d-2*u75
  u90=7.5d0*u65
  ...
  u64=-1.69256875064326886d-1*u75
  u75=4.5d1*u65
  ...
  u62=-2.25d1*u73
  u85=-1.6d1*u89
  u94=u71*(1.86107654345079183d2*u64+u85)*u75
  u78=1.69256875064326886d0*u94
  u90=2.0d0*pd2
  u98=+u67*(1.67496888910571265d3*u64+u85*(9.0d0+u90))*u75
  u65=u98*u69
  value=value+(c(21)*((u69*(u78+u65)+u62)*y))
  u79=8.46284375321634431d-1*u94
  u63=2.82094791773878144d-1*u94
  u86=u63*u69
  ...
  u86=-3.2d1*exppd2*pd2
  u8=u71*(1.67496888910571265d3*u61+u86)*u73
  u63=2.82094791773878144d0*u8
  u79=(1.1d1+u90)
  u78=u71*(1.84246577801628391d4*u61+u86*u79)*u73
  u94=-2.82094791773878144d-1*u78
  u62=u94*u69
  value=value+(c(36)*(x*(u69*(u63+u62)+u96)*y))
  u65=u71*(1.86107654345079183d2*u61-u91)*u73
  u98=1.20897767903090633d-1*u65
  u91=-1.575d2*u67
  u74=-3.15d2*u67
  u9=1.69256875064326886d0*u8
  u80=2.82094791773878144d-1*u8
  u97=u80*u69
  value=value+(c(37)*((u91+u69*(u62+u9))*u68+u69*(u74+u97)+u98))
  value=value+(c(38)*((u69*(u9+u62)+u91)*u88))
  u64=-4.725d2*u67
  u7=8.46284375321634431d-1*u8
  u72=(u7+u62)
  u75=u72*u68
  u95=u7*u69
  ...
  u82=-8.05985119353937553d-2*u71*(5.58322963035237549d2*u61-u92)*u73
  u62=-2.82094791773878144d-1*u8
  u97=-1.12837916709551257d0*u71*(5.02490666731713794d3*u61+u84*(6.0d0+&
 &pd2))*u73
  u84=2.82094791773878144d-1*u78
  u78=u84*u69
 ...
 &2*u69)+u82))
  ...
  u62=6.04488839515453165d-1*u65
  u72=-2.3625d3*u67
  u65=4.23142187660817215d0*u8
  ...
  u75=7.875d2*u65
  u82=-3.2d1*u89
  u84=u71*(1.67496888910571265d3*u62+u82)*u72
  u64=-1.26942656298245165d1*u84
  u95=1.84246577801628391d4*u62
  u74=u71*(u95+u82*u79)*u72
  u73=4.23142187660817215d0*u74
  u78=pd2**2
  u80=(u90+1.1d1)
  u7=u71*(2.39520551142116908d5*u62+u82*(1.3d1*u80+4.0d0*u78))*u72
  u79=-2.82094791773878144d-1*u7
  ...
  u91=-4.23142187660817215d0*u84
  u96=-2.82094791773878144d0*u84
  u86=2.82094791773878144d0*u74
  u9=2.82094791773878144d-1*u74
  u97=u9*u69
  value=value+(c(58)*(x*((u91+u69*(u77+u86))*u68+u69*(u96+u97)+u75)))
  value=value+(c(59)*(x*(u69*(u86+u77)+u91)*u88))
  u63=4.725d2*u65
  u61=-8.46284375321634431d-1*u84
  u67=-5.07770625192980658d0*u84
  u88=1.69256875064326886d0*u74
  ...
  u97=-2.53885312596490329d0*u84
  u98=(u8+u77)
  u93=u92+u97
  value=value+(c(64)*(u87*(u98*u68+u93)*z))
  u92=-6.77027500257307545d0*u71*(1.86107654345079183d2*u62-4.0d0*u89)*&
 &u72
  u76=-8.46284375321634431d-1*u74
  u89=2.82094791773878144d-1*u71*(2.17745955583742644d4*u62+u82*(1.3d1+&
 &u90))*u72
  u62=-4.5135166683820503d0*u71*(u95+u83*(4.0d0*u80+u78))*u72
  u72=2.82094791773878144d-1*u7
  u7=-2.82094791773878144d-1*u74
  u78=u72*u69
  u95=u69*(u78+u62)
 ...
 &2)))
  ...
  u81=5.5125d3*u65
  u65=-2.96199531362572051d1*u84
  u84=5.92399062725144101d0*u74
...
!> Compute YY X Y coulomb integral for the right hand shell 
!!
recursive function D_X_R_opt_1_3(a12,a3,r3,c,lmax,value)
  ...
  u65=A3_(p,pd,erfpd,exppd2)
  u76=p**3
  u77=-1.5d0*u71*u65*u76
  u89=x*z
  value=value+(c(2)*(u77*u89))
  u87=y*z
  value=value+(c(3)*(u77*u87))
  u66=9.40315972579593812d-2*u71*(5.31736155271654808d0*u65+4.0d0*exppd&
 &2)*u76
  u69=z**2
  ...
  u90=exppd2*pd
  u83=-8.0d0*u90
  u86=+u67*(2.65868077635827404d1*u66+u83)*u77
  u68=x**2
  ...
  u93=8.0d0*exppd2
  u79=u71*(u93+2.65868077635827404d1*u63)*u74
  u85=-5.64189583547756287d-2*u79
  ...
  u64=-1.69256875064326886d-1*u79
  u75=4.5d1*u86
  ...
  u63=-2.25d1*u7
  u85=-1.6d1*u90
  u79=u71*(1.86107654345079183d2*u64+u85)*u75
  u9=1.69256875064326886d0*u79
  u91=2.0d0*pd2
  u94=+u67*(1.67496888910571265d3*u64+u85*(9.0d0+u91))*u75
  u74=u94*u68
  value=value+(c(21)*((u68*(u9+u74)+u63)*z))
  u67=8.46284375321634431d-1*u79
  value=value+(c(22)*(x*(u74+u67)*u87))
  u86=2.82094791773878144d-1*u79
  u73=u86*u68
  ...
  u74=-7.875d2*u75
  u86=-3.2d1*exppd2*pd2
  u67=u71*(1.67496888910571265d3*u98+u86)*u73
  u9=2.82094791773878144d0*u67
  u79=(1.1d1+u91)
  u63=u71*(1.84246577801628391d4*u98+u86*u79)*u73
  u97=-2.82094791773878144d-1*u63
  u64=u97*u68
  value=value+(c(36)*(x*(u68*(u9+u64)+u74)*z))
  u94=-1.575d2*u75
  u7=1.69256875064326886d0*u67
  value=value+(c(37)*((u68*(u7+u64)+u94)*u87))
  u8=u71*(1.86107654345079183d2*u98-u92)*u73
  u99=1.20897767903090633d-1*u8
  u92=-3.15d2*u75
  u78=2.82094791773878144d-1*u67
  u82=u78*u68
  value=value+(c(38)*((u94+u68*(u64+u7))*u69+u68*(u92+u82)+u99))
  u80=8.46284375321634431d-1*u67
  u66=(u80+u64)
  u72=u82+u94
  ...
  u72=-8.05985119353937553d-2*u71*(5.58322963035237549d2*u98-u93)*u73
  u96=-2.82094791773878144d-1*u67
  u76=-1.12837916709551257d0*u71*(5.02490666731713794d3*u98+u84*(6.0d0+&
 &pd2))*u73
  u98=2.82094791773878144d-1*u63
  u63=u98*u68
 ...
 &6*u68)+u72))
  ...
  u76=6.04488839515453165d-1*u8
  u72=-2.3625d3*u75
  u63=4.23142187660817215d0*u67
  ...
  u64=7.875d2*u63
  u82=-3.2d1*u90
  u65=u71*(1.67496888910571265d3*u76+u82)*u72
  u66=-1.26942656298245165d1*u65
  u96=1.84246577801628391d4*u76
  u74=u71*(u96+u82*u79)*u72
  u93=4.23142187660817215d0*u74
  u78=pd2**2
  u80=(u91+1.1d1)
  u7=u71*(2.39520551142116908d5*u76+u82*(1.3d1*u80+4.0d0*u78))*u72
  u79=-2.82094791773878144d-1*u7
  u92=u79*u68
  value=value+(c(57)*((u68*(u66+u68*(u92+u93))+u64)*z))
  u67=-4.23142187660817215d0*u65
  u73=2.82094791773878144d0*u74
  value=value+(c(58)*(x*(u68*(u73+u92)+u67)*u87))
  u97=-2.82094791773878144d0*u65
  u9=2.82094791773878144d-1*u74
  u95=u9*u68
  value=value+(c(59)*(x*((u67+u68*(u92+u73))*u69+u68*(u97+u95)+u64)))
  u75=1.575d2*u63
  u89=-8.46284375321634431d-1*u65
  u98=-1.69256875064326886d0*u65
  u87=1.69256875064326886d0*u74
  u99=(u89+u68*(u92+u87))
  u85=u68*(u98+u95)+u75
  ...
  u85=4.725d2*u63
  u99=-5.07770625192980658d0*u65
  u8=8.46284375321634431d-1*u74
  u86=u8*u68
  value=value+(c(62)*(z*(u95+u68*(u99+u86)+u85)))
  u84=-2.53885312596490329d0*u65
  u94=(u8+u92)
  u95=u86+u84
  value=value+(c(63)*(u88*(u94*u70+u95)*z))
  u86=-6.77027500257307545d0*u71*(1.86107654345079183d2*u76-4.0d0*u90)*&
 &u72
  u77=-8.46284375321634431d-1*u74
  u90=2.82094791773878144d-1*u71*(2.17745955583742644d4*u76+u82*(1.3d1+&
 &u91))*u72
  u76=-4.5135166683820503d0*u71*(u96+u83*(4.0d0*u80+u78))*u72
  u71=2.82094791773878144d-1*u7
  u7=-2.82094791773878144d-1*u74
  u80=u71*u68
  u96=u68*(u80+u76)
 ...
 &6)))
  ...
  u64=5.5125d3*u63
  u63=-2.96199531362572051d1*u65
  u65=5.92399062725144101d0*u74
...
!!
recursive function D_X_R_opt_1(a12,a3,r3,ny3,nz3,c,lmax,value)
  ...
  logical                   :: D_X_R_opt_1 !< true if the routine knows how to calculate the requested value
  ...
  select case ((ny3+nz3)*(ny3+nz3+1)/2+nz3+1)
    case (1)
      D_X_R_opt_1 = D_X_R_opt_1_1(a12,a3,r3,c,lmax,value)
    case (2)
      D_X_R_opt_1 = D_X_R_opt_1_2(a12,a3,r3,c,lmax,value)
    case (3)
      D_X_R_opt_1 = D_X_R_opt_1_3(a12,a3,r3,c,lmax,value)
    case default
      D_X_R_opt_1 = .false.
  end select
end function
