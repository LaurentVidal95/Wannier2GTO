module mod_D_X_Y_shell_optv1_0
  
  implicit none
  
  private
  public :: D_X_Y_shell_optv1_0
...
!!
recursive function D_X_Y_shell_optv1_0(a12,a3,r3,c,lmax,value)
